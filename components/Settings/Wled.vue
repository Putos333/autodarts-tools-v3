<template>
  <template v-if="!$attrs['data-feature-index']">
          ...
          >
            ...
            <div class="flex w-full flex-wrap gap-2 sm:w-auto">
              <AppButton
                ...
                auto
                title="Effekte nach Triggern sortieren"
              >
              ...
              >
                ...
                <span class="whitespace-nowrap">CSV importieren</span>
              </AppButton>
            </div>
          </h3>
          <div class="space-y-3 text-white/70">
            <p>
              Konfiguriere die WLED-Effekte, die während des Spiels abgespielt werden. Wenn Board-IDs definiert sind, wird der
              effects are only played for throws on these boards. The 'other' effect is triggered
              for throws on other boards.
            </p>
            <div class="mt-4 space-y-4">
              <div class="grid grid-cols-[auto_1fr] gap-4">
                <p>Board-IDs:<br><span class="text-xs text-white/60">(eine pro Zeile)</span></p>
                <AppTextarea
                  id="wled-boards"
    ...
    <!-- Import CSV Modal -->
    <AppModal @close="closeImportCSVModal" :show="showImportCSVModal" size="xl" title="CSV importieren">
      <div class="space-y-4">
        <div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <AppInput
              ...
              type="text"
              placeholder="Name für diesen Effekt eingeben"
              class="pl-9"
            />
          </div>
        </div>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Löst WLED-Effekte (oder beliebige URLs) für Ereignisse wie Game-On, Take-out und Match-Sieg aus.
          </p>
        </div>
        <div class="flex">
          <div
