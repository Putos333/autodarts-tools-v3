      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Streaming-Modus
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Konfiguriere die Streaming-Modus-Einstellungen für deine Übertragungen.</p>
            ...
            <div class="mt-4 space-y-4">
              ...
              <div v-if="backgroundMode" class="grid grid-cols-[auto_1fr] items-center gap-4">
                ...
                <p>Lade ein eigenes Hintergrundbild für den Streaming-Modus hoch</p>
              ...
              <div class="mt-6">
                ...
                <input
                  ...
                  placeholder="Text für die untere Streaming-Overlay-Leiste eingeben"
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Optimiert die Oberfläche fürs Streaming mit individuellen Hintergründen und Layouts.
          </p>
        </div>
        <div class="flex">
