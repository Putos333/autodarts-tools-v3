      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <div class="space-y-3 text-white/70">
            ...
            <p>Wenn aktiviert, erscheint in der Lobby ein Button, mit dem die Spieler-Reihenfolge zufällig gemischt werden kann.</p>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Fügt in der Lobby einen Button hinzu, der die Reihenfolge der Spieler in <b>privaten Lobbies</b> zufällig mischt.
          </p>
        </div>
        <div class="flex">
...
const imageUrl = browser.runtime.getURL("/images/shuffle-players.svg");
