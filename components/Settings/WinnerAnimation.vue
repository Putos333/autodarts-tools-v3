      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Gewinner-Animation
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Konfiguriere die Einstellungen der Gewinner-Animation.</p>

            <div class="mt-4 space-y-4">
              <!-- No additional settings needed for this feature -->
              <p>Diese Funktion zeigt eine Animation rund um die Spielerkarte, sobald ein Leg gewonnen wird.</p>
              <p>Die Animationen selbst kannst du im Menü „Animationen" anpassen.</p>
            </div>
          </div>
        </div>
      </div>
