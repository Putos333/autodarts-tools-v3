      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Instant Replay
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Passe hier deine Instant-Replay-Einstellungen an.</p>

            <div v-if="!hasCameraPermission && !cameraError">
              <p class="mb-2">
                Für diese Funktion wird Kamera-Zugriff benötigt.
              </p>
              <AppButton @click="requestCameraAccess" class="mb-4">
                <span class="icon-[pixelarticons--camera] mr-2" />
                <span>Kamera-Zugriff erlauben</span>
              </AppButton>
            </div>
            ...
            <div v-if="hasCameraPermission" class="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div class="space-y-4">
                <div>
                  <div class="mb-1 flex items-center justify-between">
                    <label class="text-sm font-medium">Kamera auswählen</label>
                    <AppButton
                  ...
                  <p v-if="!cameraDevices.length && hasCameraPermission" class="mt-1 text-xs text-white/60">
                    Keine verfügbare Kamera gefunden. Möglicherweise wird sie von einer anderen Anwendung genutzt.
                  </p>
                  <p v-else-if="cameraDevices.length && hasCameraPermission" class="mt-1 text-xs text-white/60">
                    Es werden nur Kameras angezeigt, die aktuell von keiner anderen Anwendung genutzt werden.
                  </p>
                </div>
                ...
                <p class="text-sm text-white/60">
                  Lege fest, wie viele Sekunden Video für das Instant Replay gespeichert werden (5-30 Sekunden).
                </p>
                ...
                <p class="text-sm text-white/60">
                  Lege fest, wie viele Sekunden vor dem Ereignis das Replay starten soll (0-10 Sekunden).
                </p>

                <div>
                  <label class="mb-1 block text-sm font-medium">Ansicht</label>
                  <AppSelect
                    v-model="viewMode"
                    :options="[
                      { value: 'full-page', label: 'Vollbild' },
                      { value: 'board-only', label: 'Nur Board' },
                    ]"
                    class="w-full"
                  />
                </div>
                <p class="text-sm text-white/60">
                  Wähle, wie das Replay dargestellt wird. „Vollbild" nutzt den gesamten Bildschirm, „Nur Board" zeigt es direkt über dem Dartboard.
                </p>

                <div>
                  <label class="mb-1 block text-sm font-medium">Kamera-Zoom</label>
                  ...
                  <p class="mt-1 text-sm text-white/60">
                    Zoom-Stufe: {{ zoomLevel.toFixed(1) }}x
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-4">
                      ...
                      <AppSlider
                        ...
                        class="w-full"
                      />
                      <span class="text-sm">Rechts</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-4">
                      ...
                      <AppSlider
                        ...
                        class="w-full"
                      />
                      <span class="text-sm">Unten</span>
                    </div>
                  </div>
                  <p class="mt-1 text-sm text-white/60">
                    Positioniere die Kamera-Ansicht beim Heranzoomen.
                  </p>
                </div>
              </div>
              ...
              <div>
                <label class="mb-1 block text-sm font-medium">Kamera-Vorschau</label>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Zeichnet deine Webcam auf und ermöglicht das Ansehen von Würfen mit einstellbarer Dauer und Verzögerung.
          </p>
        </div>
        <div class="flex">
