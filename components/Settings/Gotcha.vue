<template>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Gotcha-Helfer
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Zeigt an, wie viele Punkte die Mitspieler voraus sind.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <template v-else>
    ...
    <div v-if="config" class="adt-container h-56 transition-transform hover:-translate-y-0.5">
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">Gotcha-Helfer</h3>
          <p class="w-2/3 text-white/70">
            Zeigt an, wie viele Punkte die Mitspieler voraus sind.
          </p>
        </div>
