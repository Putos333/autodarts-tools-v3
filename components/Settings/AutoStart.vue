    ...
    <div class="relative z-10 flex h-full flex-col justify-between">
      <div>
        ...
        <p class="w-2/3 text-white/70">
          Zeigt einen Button auf der Lobby-Seite an, mit dem der automatische Spielstart aktiviert werden kann. Wenn Autostart aktiv ist, startet das Spiel automatisch nach <b>3 Sekunden</b>, sobald ein Spieler die Lobby betritt.
        </p>
      </div>
      <div class="flex">
