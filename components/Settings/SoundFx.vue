      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 flex flex-col items-start gap-2 font-bold uppercase sm:flex-row sm:items-center sm:justify-between">
            <span>Einstellungen – Sound-FX</span>
            <div class="flex w-full flex-wrap gap-2 sm:w-auto">
              <AppButton @click="sortSoundsByTriggers" size="sm" class="!py-1 text-xs sm:text-sm" auto title="Sounds nach Triggern sortieren">
                <span class="icon-[pixelarticons--sort-alphabetic] mr-1" />
                <span class="whitespace-nowrap">Sortieren</span>
              </AppButton>
              <AppButton @click="openDeleteAllModal" size="sm" class="!py-1 text-xs sm:text-sm" auto type="danger" title="Alle Sounds löschen">
                <span class="icon-[pixelarticons--trash] mr-1" />
                <span class="whitespace-nowrap">Alle löschen</span>
              </AppButton>
              <AppButton @click="openTTSModal()" size="sm" class="!py-1 text-xs sm:text-sm" auto type="warning" :disabled="!isTTSAvailable" title="Sound aus Text-to-Speech generieren">
          ...
          <div class="space-y-3 text-white/70">
            <p>Konfiguriere Sound-Effekte, die bei besonderen Ereignissen im Spiel abgespielt werden.</p>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Spielt Sound-Effekte für besondere Ereignisse wie 180er, Checkouts und Match-Gewinne ab.
          </p>
        </div>
        <div class="flex">
