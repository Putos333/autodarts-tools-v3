      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Kleinere Punkteanzeige
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Konfiguriere, wie die Punkte der inaktiven Spieler dargestellt werden.</p>

            <div class="mt-4 space-y-4">
              <!-- No additional settings needed for this feature -->
              <p>Diese Funktion reduziert die Schriftgröße der Punkteanzeige inaktiver Spieler.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <template v-else>
    ...
    >
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Kleinere Punkteanzeige
          </h3>
          <p class="w-2/3 text-white/70">
            Verkleinert die Schriftgröße der Punkteanzeige inaktiver Spieler, um den Fokus auf den aktuellen Spieler zu lenken.
          </p>
        </div>
        <div class="flex">
