      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Take-out-Benachrichtigung
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Diese Funktion benötigt keine weiteren Einstellungen.</p>
            <p>Wenn aktiviert, wird eine Benachrichtigung eingeblendet, sobald ein Take-out der Darts läuft.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <template v-else>
    ...
    >
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Take-out-Benachrichtigung
          </h3>
          <p class="w-2/3 text-white/70">
            Zeigt eine Benachrichtigung, sobald ein Take-out der Darts läuft.
          </p>
        </div>
        <div class="flex">
