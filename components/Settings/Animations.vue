<template>
  <template v-if="!$attrs['data-feature-index']">
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 flex flex-col items-start gap-2 font-bold uppercase sm:flex-row sm:items-center sm:justify-between">
            <span>Einstellungen – Animationen</span>
            <div class="flex w-full flex-wrap gap-2 sm:w-auto">
              <AppButton @click="sortAnimationsByTriggers" size="sm" class="!py-1 text-xs sm:text-sm" auto title="Animationen nach Triggern sortieren">
                <span class="icon-[pixelarticons--sort-alphabetic] mr-1" />
                <span class="whitespace-nowrap">Sortieren</span>
              </AppButton>
              <AppButton @click="openDeleteAllModal" size="sm" class="!py-1 text-xs sm:text-sm" auto type="danger" title="Alle Animationen löschen">
              ...
              <AppButton @click="openGifUploadModal" size="sm" class="!py-1 text-xs sm:text-sm" auto type="success">
                ...
                <span class="whitespace-nowrap">GIFs hochladen</span>
              </AppButton>
            </div>
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Konfiguriere die Animationen für das Spiel. Klicke auf das Plus-Symbol, um eine neue Animation hinzuzufügen.</p>
            ...
            >
              ...
              >
                <div class="flex flex-col items-center">
                  ...
                  <span>Animation hinzufügen</span>
                </div>
              </div>
      ...
      <div class="space-y-4">
        <div>
          ...
          <p v-if="isUploadedGif" class="mt-1 text-xs text-white/60">
            Diese GIF-Datei wurde im Browser-Speicher gespeichert und kann nicht direkt bearbeitet werden.
          </p>
        </div>
    ...
    <AppModal
      ...
      title="Animations-GIFs hochladen"
    >
      <div class="space-y-4">
        <div
        ...
        <div v-if="selectedGifFiles.length > 0" class="mt-4">
          <h4 class="mb-2 text-sm font-medium">
            Ausgewählte Dateien ({{ selectedGifFiles.length }})
          </h4>
        ...
        <div class="mt-4 space-y-3">
          <div class="flex items-center">
            ...
            <span
              ...
              title="Wenn aktiviert, werden Trigger automatisch aus den Dateinamen generiert. Beispiel: 180.gif löst bei einem 180er-Wurf aus."
            />
          </div>
    ...
    <AppModal
      ...
      title="Alle Animationen löschen"
    >
      <div class="space-y-4">
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Zeigt Animationen für besondere Ereignisse wie 180er, Bulls, Busts und Leg-Gewinne während des Spiels.
          </p>
        </div>
        <div class="flex">
