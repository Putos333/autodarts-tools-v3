      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <div class="space-y-3 text-white/70">
            <p>Passe die Farben von Dart-Würfen und Punkteanzeigen an.</p>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Passe die Farben von Dart-Würfen und Punkteanzeigen nach deinen Vorlieben an.
          </p>
        </div>
        <div class="flex">
...
const imageUrl = browser.runtime.getURL("/images/colors.svg");
