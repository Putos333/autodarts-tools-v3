      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          <h3 class="mb-1 font-bold uppercase">
            Einstellungen – Größere Match-Daten
          </h3>
          <div class="space-y-3 text-white/70">
            <p>Konfiguriere die Anzeige-Größe der Spieler-Match-Daten im Match.</p>
            ...
            <div class="mt-4 space-y-4">
              ...
              <p class="text-sm text-white/50">
                ...
                Beispiel: Ein Wert von 1.5 vergrößert die Match-Daten um 50 % gegenüber dem Standard.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="relative z-10 flex h-full flex-col justify-between">
        <div>
          ...
          <p class="w-2/3 text-white/70">
            Vergrößert die Match-Daten der Spieler im Match für bessere Lesbarkeit.
          </p>
        </div>
        <div class="flex">
