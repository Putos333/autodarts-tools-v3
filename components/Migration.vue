<template>
  <AppModal @close="closeModal" size="lg" :show="showModal" title="Update verfügbar">
    <p class="mb-4 text-[var(--chakra-colors-whiteAlpha-900)]">
      Eine neue Version von <b>Tools for Autodarts</b> ist verfügbar. Du kannst deine Einstellungen jetzt migrieren oder mit Standard-Einstellungen fortfahren.
    </p>

    <div class="mb-4 rounded-md border border-yellow-700/50 bg-yellow-800/30 p-3">
      <p class="text-sm text-yellow-200">
        <b>Hinweis:</b> Sound, Caller und Animationen wurden überarbeitet — ihre Einstellungen können nicht automatisch migriert werden.
        Du kannst deine alten Einstellungen als Referenz herunterladen.
      </p>
    ...
    <p class="text-sm opacity-60">
      Ohne Migration werden alle Einstellungen auf die Standardwerte zurückgesetzt.
    </p>

    <template #footer>
      <AppButton @click="showConfirmDialog" type="danger">
        Ohne Migration fortfahren
      </AppButton>
  ...
  <ConfirmDialog
    ...
    message="Alle Einstellungen werden auf die Standardwerte zurückgesetzt. Individuelle Konfigurationen gehen dabei verloren."
    confirm-text="Fortfahren"
    cancel-text="Zurück"
  />
  ...
  <AppNotification
    ...
    message="Einstellungen erfolgreich migriert. Die Seite wird neu geladen…"
    type="success"
    :duration="3000"
  />
</template>
